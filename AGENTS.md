...
### Discovery — Reddit
1. Check ✅ **Reddit** only
2. Click **הפעל סריקה** → wait ~25s
3. Check **לוג פעילות**: should show `נסרקו X פוסטים`
4. If extracted=0: real posts didn't match intent filter — try different keyword or use manual paste
